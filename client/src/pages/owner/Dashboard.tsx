...
const GD = {
  ...
  owner:        '#7aa2e3',
  ownerLight:   'rgba(107, 142, 214, 0.18)',
  ownerBorder:  'rgba(107, 142, 214, 0.40)',
  caramel:      '#e8b97a',
  caramelLight: 'rgba(196, 151, 106, 0.18)',
  shadowHover:  '0 12px 40px rgba(0,0,0,0.30), inset 0 1px 0 rgba(255,255,255,0.12)',
}
...
export default function Dashboard() {
  ...
  const statusBadge: Record<string, { label: string; bg: string; text: string; border: string }> = {
    AVAILABLE: { label: 'Disponible',  bg: 'rgba(27,94,59,0.25)',   text: '#4ade80', border: 'rgba(74,222,128,0.40)' },
    OCCUPIED:  { label: 'En location', bg: GD.caramelLight,          text: GD.caramel, border: 'rgba(232,185,122,0.40)' },
    RESERVED:  { label: 'Réservé',     bg: GD.ownerLight,            text: GD.owner,   border: GD.ownerBorder },
    DRAFT:     { label: 'Hors marché', bg: GD.bgMuted,               text: GD.inkFaint, border: GD.border },
  }
  ...
  const contractStatusStyle = (status: string): React.CSSProperties =>
    status === 'ACTIVE'        ? { background: 'rgba(27,94,59,0.25)',     color: '#4ade80', border: '1px solid rgba(74,222,128,0.40)' } :
    status === 'DRAFT'         ? { background: GD.caramelLight,           color: GD.caramel, border: '1px solid rgba(232,185,122,0.35)' } :
    status === 'SIGNED_TENANT' ? { background: 'rgba(220,38,38,0.18)',   color: '#f87171', border: '1px solid rgba(248,113,113,0.40)' } :
    { background: GD.ownerLight, color: GD.owner, border: `1px solid ${GD.ownerBorder}` }
  ...
  if (isLoading && !statistics) {
    return (
      <Layout>
        <div style={{ background: 'linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{
            width: 36, height: 36, borderRadius: '50%',
            border: `3px solid ${GD.ownerLight}`,
            borderTopColor: GD.owner,
  ...
  if (totalProps === 0) {
    return (
      <Layout>
        <div style={{ background: 'linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 32 }}>
          <div style={{ textAlign: 'center', maxWidth: 420 }}>
            <div style={{
              width: 80, height: 80, borderRadius: 24,
              background: GD.ownerLight, border: `1px solid ${GD.ownerBorder}`,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              margin: '0 auto 24px',
            }}>
              <Home size={36} style={{ color: GD.owner }} />
            </div>
            <h2 style={{
              fontFamily: "'Cormorant Garamond', Georgia, serif",
              fontWeight: 700, fontStyle: 'italic',
              fontSize: 32, color: GD.ink, marginBottom: 12,
            }}>
              Votre patrimoine vous attend
            </h2>
            <p style={{ fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: 16, color: GD.inkMid, marginBottom: 32, lineHeight: 1.6 }}>
            ...
            <Link to="/properties/new" style={{
              ...
              background: GD.owner, color: '#ffffff',
  ...
  return (
    <Layout>
      <div style={{ background: 'linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)', minHeight: '100vh', fontFamily: "'DM Sans', system-ui, sans-serif" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-6 lg:py-8">
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, marginBottom: 32 }}>
            <div>
              <p style={{ fontSize: 13, color: GD.inkFaint, fontWeight: 400, marginBottom: 4, textTransform: 'capitalize' }}>
                {todayLabel}
              </p>
              <h1 style={{
                fontFamily: "'Cormorant Garamond', Georgia, serif",
                fontWeight: 700, fontStyle: 'italic',
                fontSize: 'clamp(32px, 6vw, 52px)', color: GD.ink, lineHeight: 1.05, margin: 0,
              }}>
          ...
          {(urgentContracts.length > 0 || pendingApps.length > 0 || drafts > 0) && (
            <div style={{
              background: GD.caramelLight, border: `1px solid #e8c9a0`,
              borderLeft: `3px solid ${GD.caramel}`,
              borderRadius: 12, padding: '12px 16px',
              display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center',
              marginBottom: 28,
            }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, flex: 1 }}>
                <AlertTriangle size={15} style={{ color: GD.caramel, flexShrink: 0 }} />
                <span style={{ fontSize: 13, fontWeight: 600, color: GD.caramel }}>Actions requises</span>
              </div>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                {urgentContracts.length > 0 && (
                  <Link to="/contracts" style={{
                    ...
                    background: GD.caramel, color: '#ffffff',
                ...
                {drafts > 0 && (
                  <Link to="/contracts" style={{
                    display: 'inline-flex', alignItems: 'center', gap: 6,
                    padding: '6px 12px', borderRadius: 8,
                    background: GD.bgMuted, color: GD.inkMid,
                    border: `1px solid ${GD.borderStrong}`,
                    fontSize: 12, fontWeight: 600, textDecoration: 'none',
                  }}>
              ...
              const inner = (
                <div style={{
                  ...
                  onMouseEnter={(e) => {
                    if (kpi.to) {
                      ...
                      ;(e.currentTarget as HTMLElement).style.boxShadow = GD.shadowHover
                    }
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  <div style={{
                    ...
                    background: `linear-gradient(90deg, ${GD.owner}, ${GD.ownerBorder})`,
                    borderRadius: '16px 16px 0 0',
                  }} />
                  <p style={{ fontSize: 11, fontWeight: 500, letterSpacing: '0.08em', textTransform: 'uppercase', color: GD.inkFaint, marginBottom: 12 }}>
                    {kpi.label}
                  </p>
                  <p style={{
                    fontFamily: "'Cormorant Garamond', Georgia, serif",
                    fontWeight: 700, fontSize: 44, color: GD.ink,
                    lineHeight: 1, marginBottom: 4,
                  }}>
                    {kpi.value}
                  </p>
                  <p style={{ fontSize: 12, color: GD.inkFaint }}>
                    {kpi.sub}
                  </p>
                  {kpi.to && (
                    <ArrowUpRight size={14} style={{ color: GD.inkFaint, marginTop: 'auto', alignSelf: 'flex-end', marginBottom: 0 }} />
                  )}
                </div>
              )
              return kpi.to ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 lg:gap-8">
            ...
            <div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                ...
                <div style={cardBase}>
                  {/* Section header */}
                  <div style={{ padding: '16px 20px', borderBottom: `1px solid ${GD.border}` }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                      <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: GD.inkFaint }}>
                        Mes biens
                      </span>
                      <Link to="/properties/owner/me" style={{
                        display: 'flex', alignItems: 'center', gap: 4,
                        fontSize: 12, fontWeight: 500, color: GD.owner, textDecoration: 'none',
                      }}>
                        Tout voir <ArrowRight size={12} />
                      </Link>
                    </div>
                    <div style={{ borderTop: `1px solid ${GD.border}` }} />
                  </div>
                      ...
                      return (
                        <button key={property.id} onClick={() => navigate(`/properties/${property.id}`)}
                          style={{
                            ...
                            border: 'none', borderBottom: isLast ? 'none' : `1px solid ${GD.border}`,
                            cursor: 'pointer', transition: 'background 0.15s',
                          }}
                          onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = GD.bgMuted }}
                        ...
                        >
                          {property.images?.[0] ? (
                            ...
                            <div style={{
                              ...
                              background: GD.bgMuted, border: `1px solid ${GD.border}`,
                              display: 'flex', alignItems: 'center', justifyContent: 'center',
                            }}>
                              <Home size={24} style={{ color: GD.inkFaint }} />
                            </div>
                          )}
                          <div style={{ flex: 1, minWidth: 0 }}>
                            <p style={{ fontSize: 14, fontWeight: 600, color: GD.ink, margin: '0 0 3px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                              {property.title}
                            </p>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 12, color: GD.inkMid }}>
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6, flexShrink: 0 }}>
                            <p style={{ fontSize: 14, fontWeight: 600, color: GD.ink, margin: 0 }}>
                              {property.price} <span style={{ fontWeight: 400, fontSize: 11, color: GD.inkFaint }}>€/mois</span>
                            </p>
                            <span style={{
                  ...
                  <div style={{ padding: '12px 20px', borderTop: `1px solid ${GD.border}` }}>
                    <Link to="/properties/new" style={{
                      display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
                      padding: '8px', borderRadius: 10, fontSize: 12, fontWeight: 500,
                      color: GD.owner, textDecoration: 'none', transition: 'background 0.15s',
                    }}
                      onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = GD.ownerLight }}
                      onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = 'transparent' }}
                    >
                ...
                <div style={cardBase}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        {upcomingVisits.length > 0 && (
                          <span style={{
                            ...
                            background: GD.owner, borderRadius: 20, padding: '1px 8px',
                  ...
                  {upcomingVisits.length === 0 ? (
                    <div style={{ textAlign: 'center', padding: '36px 24px' }}>
                      <div style={{
                        width: 40, height: 40, borderRadius: 12, background: GD.bgMuted,
                        display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px',
                      }}>
                        <CalendarCheck size={18} style={{ color: GD.inkFaint }} />
                      </div>
                      <p style={{ fontSize: 13, color: GD.inkMid }}>Aucune visite confirmée à venir</p>
                    </div>
                  ) : (
                    <div>
                      {upcomingVisits.map((visit, idx) => {
                        ...
                        return (
                          <div key={visit.id} style={{
                            ...
                            padding: '12px 20px',
                            borderBottom: isLast ? 'none' : `1px solid ${GD.border}`,
                          }}>
                            {/* Date badge */}
                            <div style={{
                              width: 44, flexShrink: 0, textAlign: 'center',
                              background: isToday ? GD.ownerLight : GD.bgMuted,
                              border: `1px solid ${isToday ? GD.ownerBorder : GD.border}`,
                              borderRadius: 10, padding: '6px 4px',
                            }}>
                              <p style={{ fontSize: 18, fontWeight: 700, lineHeight: 1, color: isToday ? GD.owner : GD.ink, fontFamily: "'Cormorant Garamond', serif", margin: 0 }}>
                                {format(visitDateObj, 'd')}
                              </p>
                              <p style={{ fontSize: 10, fontWeight: 600, color: isToday ? GD.owner : GD.inkFaint, textTransform: 'uppercase', margin: 0 }}>
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                              ...
                              <button
                                ...
                                style={{
                                  ...
                                  fontSize: 14, fontWeight: 600, color: GD.owner, textAlign: 'left',
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, color: GD.inkMid, flexWrap: 'wrap' }}>
                                <MapPin size={11} style={{ flexShrink: 0 }} />
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 3, flexShrink: 0 }}>
                              <span style={{
                                display: 'flex', alignItems: 'center', gap: 4,
                                fontSize: 13, fontWeight: 700, color: GD.ink,
                              }}>
                                <Clock size={12} style={{ color: GD.inkFaint }} />
                                {visit.visitTime}
                              </span>
                              <span style={{ fontSize: 11, color: GD.inkFaint }}>{visit.duration} min</span>
                            </div>
                          </div>
                        )
                      })}
                  ...
                  {pendingApps.length === 0 ? (
                    <div style={{ textAlign: 'center', padding: '40px 24px' }}>
                      <div style={{
                        ...
                        <Users size={18} style={{ color: GD.inkFaint }} />
                      </div>
                      <p style={{ fontSize: 13, color: GD.inkMid }}>Aucune candidature en attente</p>
                    </div>
                  ) : (
                    <div>
                      {pendingApps.slice(0, 4).map((app, idx) => {
                        const isLast = idx === Math.min(pendingApps.length, 4) - 1
                        const scoreStroke = app.score >= 70 ? '#1b5e3b' : app.score >= 40 ? GD.caramel : '#b91c1c'
                          ...
                          <div key={app.id} style={{
                            ...
                            <div style={{ position: 'relative', width: 40, height: 40, flexShrink: 0 }}>
                              <svg width="40" height="40" viewBox="0 0 40 40" style={{ transform: 'rotate(-90deg)' }}>
                                <circle cx="20" cy="20" r="16" strokeWidth="3" fill="none" stroke={GD.bgMuted} />
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                              <p style={{ fontSize: 14, fontWeight: 600, color: GD.ink, margin: '0 0 2px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                {app.tenant?.firstName} {app.tenant?.lastName}
                              </p>
                              <p style={{ fontSize: 12, color: GD.inkMid, margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  ...
                  {contracts.length === 0 ? (
                    <div style={{ textAlign: 'center', padding: '40px 24px' }}>
                      <div style={{
                        ...
                        <FileText size={18} style={{ color: GD.inkFaint }} />
                      </div>
                      <p style={{ fontSize: 13, color: GD.inkMid, marginBottom: 16 }}>Aucun contrat</p>
                        ...
                        return (
                          ...
                          >
                            <div style={{ flex: 1, minWidth: 0 }}>
                              ...
                              <p style={{ fontSize: 12, color: GD.inkMid, margin: 0 }}>
            ...
            <div className="hidden lg:flex" style={{ flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ ...cardBase, padding: 20 }}>
                <p style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: GD.inkFaint, marginBottom: 16 }}>
                  Activité
                </p>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={label} style={{
                      padding: '14px 12px',
                      background: GD.bgMuted,
                      borderRadius: 12,
                      border: `1px solid ${GD.border}`,
                    }}>
                      <div style={{
                        width: 24, height: 24, borderRadius: 7, marginBottom: 10,
                        background: GD.ownerLight, display: 'flex', alignItems: 'center', justifyContent: 'center',
                        color: GD.owner,
                      }}>
                        {icon}
                      </div>
                      <p style={{
                        fontFamily: "'Cormorant Garamond', Georgia, serif",
                        fontSize: 40, fontWeight: 700, color: GD.ink,
                        lineHeight: 1, margin: '0 0 5px',
                      }}>
                        {value}
                      </p>
                      <p style={{ fontSize: 11, color: GD.inkMid, margin: 0, lineHeight: 1.4 }}>
                        {label}
                      </p>
                    </div>
                  ))}
              ...
              <div style={{ ...cardBase, padding: 20 }}>
                  ...
                  {[
                    ...
                    <div key={label}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
                        <span style={{ fontSize: 12, color: GD.inkMid }}>{label}</span>
                        <span style={{ fontSize: 12, fontWeight: 600, color: GD.ink }}>{value}</span>
                      </div>
                      <div style={{ height: 4, borderRadius: 4, background: GD.bgMuted, overflow: 'hidden' }}>
                        <div style={{
                ...
                <div style={{ paddingTop: 12, borderTop: `1px solid ${GD.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ fontSize: 12, color: GD.inkMid }}>Total</span>
                  <span style={{ fontSize: 13, fontWeight: 700, color: GD.ink }}>{totalProps} bien{totalProps > 1 ? 's' : ''}</span>
                </div>
              </div>
              ...
              <div style={{ ...cardBase, padding: 20 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
                  <p style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: GD.inkFaint, margin: 0 }}>
                    Finances
                  </p>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {[
                    ...
                    <div key={label} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      ...
                      <span style={{
                        fontFamily: "'Cormorant Garamond', Georgia, serif",
                        fontSize: 20, fontWeight: 700, color: GD.ink,
                      }}>
                        {value}
                      </span>
                    </div>
