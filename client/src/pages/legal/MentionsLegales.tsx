    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl shadow-card p-8 space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">2. Hébergement</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">3. Propriété intellectuelle</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">4. Responsabilité</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">5. Droit applicable</h2>
            <p className="text-slate-600">
