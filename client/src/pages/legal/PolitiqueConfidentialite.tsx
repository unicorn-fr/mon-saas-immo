    ...
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white shadow-sm border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <span className="text-xl font-bold text-slate-900 hidden sm:block">ImmoParticuliers</span>
          </Link>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl shadow-card p-8 space-y-6">
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">1. Collecte des données</h2>
            ...
            <ul className="mt-3 space-y-2 text-slate-600 text-sm list-disc list-inside">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">2. Finalités du traitement</h2>
            <p className="text-slate-600">Vos données sont collectées pour :</p>
            <ul className="mt-3 space-y-2 text-slate-600 text-sm list-disc list-inside">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">3. Base légale</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">4. Durée de conservation</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">5. Vos droits</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">6. Sécurité</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">7. Contact DPO</h2>
            <p className="text-slate-600">
        ...
        <p className="text-sm text-slate-400 text-center mt-8">Dernière mise à jour : Février 2026</p>
      </main>
