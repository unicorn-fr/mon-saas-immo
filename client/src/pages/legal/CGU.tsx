    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl shadow-card p-8 space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">3. Inscription</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">4. Obligations des utilisateurs</h2>
            <p className="text-slate-600">L'utilisateur s'engage à :</p>
            <ul className="mt-3 space-y-2 text-slate-600 text-sm list-disc list-inside">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">8. Modification des CGU</h2>
            <p className="text-slate-600">
