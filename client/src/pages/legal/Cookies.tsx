    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl shadow-card p-8 space-y-6">
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">1. Qu'est-ce qu'un cookie ?</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">2. Cookies utilisés</h2>
            <div className="overflow-x-auto">
              <table className="w-full mt-3 text-sm">
                <thead>
                  <tr className="border-b border-slate-200">
                    <th className="text-left py-2 pr-4 font-semibold text-slate-900">Cookie</th>
                    <th className="text-left py-2 pr-4 font-semibold text-slate-900">Type</th>
                    <th className="text-left py-2 pr-4 font-semibold text-slate-900">Durée</th>
                    <th className="text-left py-2 font-semibold text-slate-900">Finalité</th>
                  </tr>
                </thead>
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">3. Gestion des cookies</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">4. Cookies tiers</h2>
            <p className="text-slate-600">
