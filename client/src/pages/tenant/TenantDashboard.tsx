...
export default function TenantDashboard() {
  ...
  useEffect(() => {
    ...
    loadFavorites()
    fetchUnreadCount()
  }, [fetchBookings, loadFavorites, fetchUnreadCount])
  ...
  useEffect(() => {
    if (properties.length > 0) {
      ...
      setFavoriteProperties(favProps.slice(0, 4)) // Show max 4
    }
  }, [properties, favoriteIds])

  // Get upcoming bookings (pending or confirmed, future dates)
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Propriétés sauvegardées</p>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              {isLoadingBookings ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-4">Aucune visite programmée</p>
                  <Link
                    to="/search"
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Gérer réservations</p>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Contacter propriétaires</p>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Mes biens sauvegardés</p>
                  </div>
                </Link>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-primary-50 to-blue-50 rounded-xl border border-primary-200 p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>Visitez plusieurs biens avant de décider</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                  <span>Préparez vos questions avant la visite</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                  <span>Vérifiez l'état général du logement</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600">Recherches effectuées</span>
                  <span className="ml-auto font-semibold text-gray-900">-</span>
                </div>
                <div className="flex items-center gap-3">
                  <Calendar className="w-4 h-4 text-gray-400" />
                  <span className="text-gray-600">Visites réservées</span>
