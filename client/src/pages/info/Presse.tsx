    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-slate-900 mb-3">Espace presse</h1>
        ...
        <div className="bg-white rounded-xl shadow-card p-8 mb-8">
          <h2 className="text-xl font-semibold text-slate-900 mb-4">À propos d'ImmoParticuliers</h2>
        ...
        <div className="bg-white rounded-xl shadow-card p-8 mb-8">
          <h2 className="text-xl font-semibold text-slate-900 mb-4">Kit presse</h2>
          <p className="text-slate-600 mb-4">
            Téléchargez notre kit presse contenant le logo, les photos officielles
            et un dossier de présentation.
          </p>
          <button className="btn btn-secondary flex items-center gap-2" onClick={() => alert('Kit presse bientôt disponible')}>
        ...
        <div className="bg-white rounded-xl shadow-card p-8">
          <h2 className="text-xl font-semibold text-slate-900 mb-4">Contact presse</h2>
          <p className="text-slate-600 mb-4">
            Pour toute demande d'interview, de partenariat média ou d'information complémentaire :
          </p>
          <div className="flex items-center gap-3">
            <Mail className="w-5 h-5 text-primary-500" />
            <span className="text-slate-700 font-medium">presse@immoparticuliers.fr</span>
          </div>
        </div>
      </main>
