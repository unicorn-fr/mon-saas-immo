    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-slate-900 mb-3">Nous contacter</h1>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="card text-center">
            ...
            <p className="text-sm text-slate-600">contact@immoparticuliers.fr</p>
          </div>
          <div className="card text-center">
            <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <p className="text-sm text-slate-600">01 XX XX XX XX</p>
          ...
          <div className="card text-center">
            ...
            <p className="text-sm text-slate-600">12 Rue de la Paix</p>
            <p className="text-xs text-slate-400">75002 Paris, France</p>
          </div>
        </div>
