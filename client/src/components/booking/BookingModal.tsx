      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
          ...
          <div className="flex items-start justify-between p-6 border-b">
            <div>
              <h2 className="text-2xl font-bold text-slate-900">Réserver une visite</h2>
              <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">{propertyTitle}</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
            {showSuccess ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Duration Info */}
                {selectedTime && (
                  <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 bg-slate-50/50 rounded-xl px-4 py-2">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none"
          ...
          {!showSuccess && (
            <div className="flex items-center justify-end gap-3 p-6 border-t bg-slate-50/50">
              <button
                ...
                className="px-6 py-2 text-slate-700 dark:text-slate-300 bg-white border border-slate-300 rounded-xl hover:bg-slate-50/50 transition-colors disabled:opacity-50"
              >
                Annuler
              </button>
              <button
                ...
                className="px-6 py-2 bg-primary-600 text-white rounded-xl hover:bg-primary-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isSubmitting ? (
                  <>
